...
void getMaterialStruct(MyMediumProp *volume_container, std::vector<vecgeom::LogicalVolume *> logicalvolumes, bool on_gpu) {
	...
	for (auto lvol : logicalvolumes) {
      ...
      if (!strcmp(lvol->GetName(), "World")) {
        ...
        volume_container[i].fObjColor = 0xFF000080;
      			...
      			!strcmp(lvol->GetName(), "M12_12") || !strcmp(lvol->GetName(), "M12_120x2") || !strcmp(lvol->GetName(), "M12_120x4") ||
      			!strcmp(lvol->GetName(), "M12_2")  || !strcmp(lvol->GetName(), "M12_20x2")  || !strcmp(lvol->GetName(), "M12_20x4")  ||
      			!strcmp(lvol->GetName(), "M12_4")  || !strcmp(lvol->GetName(), "M12_40x2")  || !strcmp(lvol->GetName(), "M12_40x4")  ||
      			!strcmp(lvol->GetName(), "M12_6")  || !strcmp(lvol->GetName(), "M12_60x2")  || !strcmp(lvol->GetName(), "M12_60x4")  ||
      			!strcmp(lvol->GetName(), "M12_8")  || !strcmp(lvol->GetName(), "M12_80x2")  || !strcmp(lvol->GetName(), "M12_80x4")  ||
      			!strcmp(lvol->GetName(), "M14_10") || !strcmp(lvol->GetName(), "M14_100x2") || !strcmp(lvol->GetName(), "M14_100x4") ||
      			!strcmp(lvol->GetName(), "M14_12") || !strcmp(lvol->GetName(), "M14_120x2") || !strcmp(lvol->GetName(), "M14_120x4") ||
      			!strcmp(lvol->GetName(), "M13_2")  || !strcmp(lvol->GetName(), "M13_4")     || !strcmp(lvol->GetName(), "M13_6")     ||
      			!strcmp(lvol->GetName(), "M13_8")  || !strcmp(lvol->GetName(), "M16_6")     || !strcmp(lvol->GetName(), "M16_60x2")  ||
      			!strcmp(lvol->GetName(), "M14_2")  || !strcmp(lvol->GetName(), "M14_20x2")  || !strcmp(lvol->GetName(), "M14_20x4")  ||
      			!strcmp(lvol->GetName(), "M14_4")  || !strcmp(lvol->GetName(), "M14_40x2")  || !strcmp(lvol->GetName(), "M14_40x4")  ||
      			!strcmp(lvol->GetName(), "M14_6")  || !strcmp(lvol->GetName(), "M14_60x2")  || !strcmp(lvol->GetName(), "M14_60x4")  ||
      			!strcmp(lvol->GetName(), "M14_8")  || !strcmp(lvol->GetName(), "M14_80x2")  || !strcmp(lvol->GetName(), "M14_80x4")  ||
      			...
      			!strcmp(lvol->GetName(), "M18_2")  || !strcmp(lvol->GetName(), "M18_20x2")  ||
				    ...
				    !strcmp(lvol->GetName(), "M7_8")   || !strcmp(lvol->GetName(), "M8_2")      ||
